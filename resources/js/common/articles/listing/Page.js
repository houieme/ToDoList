...
import { articleListRequest, articleUpdateRequest, articleRemoveRequest } from '../../../modules/article/service'
    ...
    return <main className="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
      ...
      <table className="table table-responsive table-striped">
        ...
        <tr>
          ...
          <th>mis à jour à</th>
          <th>Completé à</th>
          <th><Link to='/articles/create' className="btn btn-success">Ajouter</Link></th>
        </tr>
        </thead>
        <tbody>
        { this.renderArticles() }
